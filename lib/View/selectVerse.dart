        ...
        child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              ...
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => Bible(bibleTitle: widget.bibleTitle, biblePassenger: index, bibleChapter: widget.selectedChapter)));
              },
            );
          },
        ),
